...
//		});
	...
	public void docLenTBL() {
		for(HoSoBenhAn benh : benhAnService.findAll()) {
			Object [] ob = {benh.getHoTen(),benh.getTuoi(), benh.getDienThoai(), benh.getDiaChi(), DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm").format(benh.getNgayLap())};
			dtf.addRow(ob);
		}
	}
	...
	public void mouseClicked(MouseEvent e) {
		...
		if(o.equals(table)) {
			...
			Object [] ob = {ba.getHoTen(),ba.getTuoi(), ba.getDienThoai(), ba.getDiaChi(), DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm").format(ba.getNgayLap())};
			dtf.addRow(ob);		
